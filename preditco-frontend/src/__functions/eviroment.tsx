...
export const ActivityUrl = "http://18.102.24.178:8000/statistics/structures";
export const ProvinceUrl = "http://18.102.24.178:8000/statistics/province";

//Default value
export const provItems = ["Italia", "Estero"];
